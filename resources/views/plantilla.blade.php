...
<ul class="navbar-nav">
    <li class="nav-item active">
      <a class="nav-link" href="{{route('VincentVanGogh')}}"><h2>Vincent Van Gogh</h2></a>
    </li>
    <li class="nav-item">
    <a class="nav-link" href="{{route('RembrandtVanRijn')}}"><h2>Rembrandt Van Rijn</h2></a>
    </li>
    <li class="nav-item">
    <a class="nav-link" href="{{route('LeonardoDaVinci')}}"><h2>Leonardo Da Vinci</h2></a>
    </li>
    <li class="nav-item">
    <a class="nav-link" href="{{route('ClaudeMonet')}}"><h2>Claude Monet</h2></a>
    </li>
    <li class="nav-item">
    <a class="nav-link" href="{{route('PaulCezanne')}}"><h2>Paul Cezanne</h2></a>
    </li>
  </ul>
@stop
@section('contenido')
<article class="background2">
  <h1>Pintores</h1>
  <article class="color">
  <a href="{{route('VincentVanGogh')}}"><h2>Vincent Van Gogh</h2></a>
  ...
  <article class="color">
  <a href="{{route('RembrandtVanRijn')}}"><h2>Rembrandt Van Rijn</h2></a>
  ...
  <article class="color">
  <a href="{{route('LeonardoDaVinci')}}"><h2>Leonardo Da Vinci</h2></a>
  ...
  <article class="color">
  <a href="{{route('ClaudeMonet')}}"><h2>Claude Monet</h2></a>
  ...
  <article class="color">
  <a href="{{route('PaulCezanne')}}"><h2>Paul Cezanne</h2></a>
